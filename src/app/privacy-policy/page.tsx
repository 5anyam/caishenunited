...
export default function PrivacyPolicyPage() {
  return (
    <div className="min-h-screen bg-white dark:bg-black py-16 px-4 sm:px-6 lg:px-8 transition-colors duration-300">
      <div className="max-w-4xl mx-auto bg-white dark:bg-black p-6 lg:p-8 rounded-lg shadow-xl border border-gray-200 dark:border-[#9e734d]/20">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-2">Effective Date: November 14, 2025</p>
        ...
        <section className="space-y-8 text-sm leading-7 text-gray-700 dark:text-gray-300">
          ...
          <div className="border-l-4 border-[#8a6342] pl-6 pt-4">
            ...
            <div className="bg-gradient-to-r from-[#F5E6D3]/10 to-[#9e734d]/5 dark:from-[#9e734d]/5 dark:to-transparent p-4 rounded-lg border border-[#9e734d]/20">
              <p className="font-light">
                We may share your data with trusted service providers including payment processors, logistics partners, and analytics platforms. We comply with legal requirements when necessary. We <span className="font-medium text-[#9e734d] dark:text-[#9e734d]/80">never sell</span> your personal information to third parties. Your privacy is as important to us as the quality of our products.
              </p>
            </div>
          </div>
          ...
          <div className="border-l-4 border-[#8a6342] pl-6 pt-4">
            ...
            <div className="bg-gradient-to-r from-[#F5E6D3]/5 to-[#9e734d]/5 dark:from-[#9e734d]/5 dark:to-transparent p-4 rounded-lg border border-[#9e734d]/20">
              <p className="font-light text-gray-600 dark:text-gray-400">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 p-3 bg-[#9e734d]/5 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400">Caishen United Customer Support Team</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-3 bg-[#9e734d]/5 rounded-lg">
                  <div className="p-2 bg-gradient-to-r from-[#9e734d] to-[#8a6342] rounded-lg text-white">
