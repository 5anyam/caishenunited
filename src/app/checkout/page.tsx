    ...
    <React.Fragment>
      <div className="min-h-screen bg-white pb-10">
        <div className="max-w-2xl mx-auto py-12 px-4">
          ...
          {/* âœ¨ Premium Freebies Section - mobile cover orders only */}
          {!freeGift.eligible && freeGift.coverQty > 0 && (
            <div className="border border-dashed border-emerald-300 p-4 mb-6 rounded-lg bg-emerald-50 text-center text-xs text-emerald-700 font-medium">
...
<div className="border-2 border-dashed border-emerald-300 p-6 mb-6 rounded-lg bg-gradient-to-r from-emerald-50 via-green-50 to-emerald-50 shadow-sm relative overflow-hidden">
  ...
  <div className="bg-gradient-to-r from-[#9e734d] to-[#8a6342] p-4 text-center">
    ...
    <p className="text-white text-xs font-light leading-relaxed">
      Use code <span className="font-bold bg-white/20 px-2 py-1 rounded mx-1">CAISHEN10</span> and get
